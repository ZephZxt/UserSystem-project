<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <router-link class="navbar-brand" :to="{name: 'SellerMain'}">User System</router-link>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <router-link :class="route_name == 'SellerInfo'? 'nav-link active' : 'nav-link'" :to="{name: 'SellerInfo'}">卖家信息个人中心</router-link>
            </li>
          </ul>
